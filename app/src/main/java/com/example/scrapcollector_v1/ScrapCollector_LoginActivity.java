...
public class ScrapCollector_LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scrap_collector_login);
                ...
                if (!TextUtils.isEmpty(adm) && !TextUtils.isEmpty(pass))
                {
                    mFirebaseAuth.signInWithEmailAndPassword(adm,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            {
                                pd.dismiss();
                                startActivity(new Intent(ScrapCollector_LoginActivity.this,Welcome.class));
    ...
    public void openScrapCollectorRegisterActivity(){
        Intent screg_intent = new Intent(this, ScrapCollector_RegistrationActivity.class);
